...
Offboard a specific user or multiple users with .\M365UserOffBoarding.ps1
...
Example: user1@xxx.onmicrosoft.com, user3@xxx.onmicrosoft.com, user3@xxx.onmicrosoft.com
...
Bulk offboard users with CSV with .\M365UserOffBoarding.ps1 -CSVFilePath <csvfilepath>

user1@xxx.onmicrosoft.com
user2@xxx.onmicrosoft.com
user3@xxx.onmicrosoft.com
user4@xxx.onmicrosoft.com
user5@xxx.onmicrosoft.com
...
{
    try{
        Update-MgBetaUser -UserId $UPN -OfficeLocation "Offboarded"
