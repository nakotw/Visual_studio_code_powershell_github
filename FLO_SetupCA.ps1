...
Script de configuration automatique des conditional access policies.
...
.NOTES
    1. Ne pas oublier de désactiver le security default.
    2. Aucune des politiques créées ne sera appliquée par défault.
    3. Ne pas oublier de créer le groupe 'Exclude from CA' et ajouter l'admin et/ou breakglass.
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[All cloud apps] BLOCK: Legacy authentication clients" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[All cloud apps] GRANT: Require MFA for Admin users" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[All cloud apps] GRANT: Require MFA for All users" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[All cloud apps] BLOCK: Device platforms such as Linux and ChromeOS" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[Office 365] GRANT: Require approved apps for mobile access (MAM)" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[Office 365] GRANT: Require managed devices for Windows & MacOS (MDM)" -State "enabledForReportingButNotEnforced" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "[Office 365] SESSION: Prevent web downloads from unmanaged devices" -State "enabledForReportingButNotEnforced" -Conditions $conditions -SessionControls $controls 
