...
Write-Host ""
Write-Host "`tTool         :: FLO_MacOS_MDATP_Deployment_Add.ps1" -ForegroundColor Magenta
Write-Host "`tDescription  :: Configurer automatiquement 5 profils de configuration + 1 macOS apps" -ForegroundColor Magenta
...
$MDATP_Onboarding  = @"
{
    ...
    "displayName":  "ITI - macOS - Defender for Endpoint - Onboarding",
    "payloadName":  "ITI - macOS - MDATP Onboarding",
...
$MDATP_FullDiskAccess  = @"
{
    ...
    "displayName":  "ITI - macOS - Defender for Endpoint - Full Disk Access",
    "payloadName":  "ITI - macOS - Defender for Endpoint - Full Disk Access",
...
$MDATP_Kext  = @"
{
    ...
    "displayName":  "ITI - macOS - Defender for Endpoint - Kernel Extension",
    "payloadName":  "ITI - macOS - Defender for Endpoint - Kernel Extension",
...

{
  ...
  "developer": "Microsoft",
  "displayName": "ITI - macOS - Microsoft Defender for Endpoint (macOS)",
...

{
    ...
    "displayName":  "ITI - macOS - Defender for Endpoint - Notifications",
    "payloadName":  "ITI - macOS - Defender for Endpoint - Notifications",
...

{
    ...
    "displayName":  "ITI - macOS - Defender for Endpoint - System Extension",
    "payloadName":  "ITI - macOS - MDATP macOS System Extension",
