...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [All cloud apps] BLOCK: Legacy authentication clients" -State "Disabled" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [All cloud apps] GRANT: Require MFA for Admin users" -State "Disabled" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [All cloud apps] GRANT: Require MFA for All users" -State "Disabled" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [All cloud apps] BLOCK: Device platforms such as Linux and ChromeOS" -State "Disabled" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [Office 365] GRANT: Require approved apps for mobile access (MAM)" -State "Disabled" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [Office 365] GRANT: Require managed devices for Windows & MacOS (MDM)" -State "Disabled" -Conditions $conditions -GrantControls $controls 
...
New-AzureADMSConditionalAccessPolicy -DisplayName "TEST - [Office 365] SESSION: Prevent web downloads from unmanaged devices" -State "Disabled" -Conditions $conditions -SessionControls $controls 
