...
Download Onedrive data for a specific user (before offboarding for exemple)

.\Download-OD4BAccount.ps1 -Username user1@xxx.onmicrosoft.com -Destination "C:\temp\ONEDRIVE" -ThreadCount 3
