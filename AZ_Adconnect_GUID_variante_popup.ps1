...
Connect-MsolService
#$path = "OU=TEMPO,OU=Utilisateurs_365,OU=Utilisateurs,OU=CDLINC,DC=ecdl,DC=lan"
Add-Type -AssemblyName Microsoft.VisualBasic
$path = [Microsoft.VisualBasic.Interaction]::InputBox('Dans quelle OU AD souhaitez vous lancer le script', 'GUID Synchronisator', "")
...
##test
#set-msoluser -userprincipalname "" -immutableid xgZ3KmQnvU2RxAah/JpuGw==
#
