...
# Configuration
$username = "adminlaps"   # Administrator is built-in name
$password = ConvertTo-SecureString "BadAdminPwd123!" -AsPlainText -Force  # Super strong plane text password here (yes this isn't secure at all)
